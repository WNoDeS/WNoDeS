---
layout: default
title: "WNoDeS Hypervisor v. 2.2.0 release notes"
release_date: "20.09.2013"
rfcs:
   - id: WNODES-306
     title: Fixed - hv wrong behaviour with a wrong conf file
   - id: WNODES-300
     title: Fixed - hexception raised when the hypervisor stop
   - id: WNODES-298
     title: Fixed - Hypervisor network down
   - id: WNODES-336
