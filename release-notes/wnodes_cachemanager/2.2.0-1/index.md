---
layout: default
title: "WNoDeS Cachemanager v. 2.2.0-1 release notes"
release_date: "12.10.2013"
rfcs:
   - id: WNODES-333
     title: Fix sqlalchemy dependency name for sl6
   - id: WNODES-337
     title: Fixed - the CM pub Key is not passed through the calls correctly
   - id: WNODES-41
     title: Remove pending socket connections from CM when deleting VM  
---

## WNoDeS Cache Manager v. 2.2.0-1
